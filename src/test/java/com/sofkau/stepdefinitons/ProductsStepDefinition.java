...
import static com.sofkau.utils.ReqresResources.DELETE_PRODUCTS;
import static com.sofkau.utils.ReqresResources.DELETE_PRODUCTS_BASE;

public class ProductsStepDefinition extends ApiSetUp {
    public static org.apache.log4j.Logger LOGGER = Logger.getLogger(String.valueOf(ProductsStepDefinition.class));
